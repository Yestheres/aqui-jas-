...
ACTION_DESCRIPTIONS: dict[str, str] = {
    ...
    "sync_channel_permissions": "Sincroniza permissões do canal com a categoria.",
    "create_role": "Cria um cargo.",
    "update_role": "Atualiza nome, cor, menção ou posição de um cargo.",
    ...
    "timeout_member": "Aplica ou remove timeout de um membro.",
    "kick_member": "Expulsa um membro.",
    "ban_member": "Bane um membro.",
    "unban_member": "Remove o banimento de um usuário.",
